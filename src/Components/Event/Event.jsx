...
import image4 from '../../assets/image/image box (11).png';
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-10">
        ...
        <span>5 posts</span>
          ...
          <p className="text-gray-700 text-[15px] sm:text-[17px] md:text-[18px] leading-relaxed">
           Browse our visual gallery featuring photos from IP conferences, 
client meetings, legal workshops, and SUPREMEiP activities worldwide.
See how we represent innovation and legal excellence through 
moments that matter.
          </p>
        </div>

        {/* Right Image Section */}
        <div className=" md:w-1/3  h-[250px] object-cover flex justify-center md:justify-end">
          <img
            src={EventImg}
            alt="Assignment"
