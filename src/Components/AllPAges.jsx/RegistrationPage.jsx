...
import RegistrationImg from '../../assets/image/Registration.png'
      ...
      <div className="max-w-4xl mx-auto flex flex-col md:flex-row justify-between items-center gap-10">
        ...
        <span>6 posts</span>
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 text-gray-900">
            Registration<span className="text-green-400">•</span>
          </h2>
          <p className="text-gray-700 text-[15px] sm:text-[17px] md:text-[18px] leading-relaxed">
         Simplify your IP registration process with MENTORIP. We handle 
end-to-end registration of trademarks, patents, designs, and 
copyrights — ensuring compliance, speed, and protection both 
