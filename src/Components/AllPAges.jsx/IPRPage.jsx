...
import IPRImg from '../../assets/image/IPR.png'
...
import image9 from '../../assets/image/image box (3).png';
import image10 from '../../assets/image/image box (11).png';
    ...
    return (
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-10">
        ...
        <span>8 posts</span>
         ...
         Enforce your intellectual property rights with confidence. 
MENTORIP offers comprehensive IPR enforcement services, 
including raids, legal action, customs intervention, and 
anti-counterfeiting strategies — locally and globally.
          </p>
        </div>
