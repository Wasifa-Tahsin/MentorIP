...
import IPLawsImg from '../../assets/image/IPLaws.png'
      ...
      <div className="max-w-4xl mx-auto flex flex-col md:flex-row justify-between items-center gap-10">
        ...
        <span>6 posts</span>
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 text-gray-900">
            IP Laws and Rules<span className="text-green-400">•</span>
          </h2>
          <p className="text-gray-700 text-[15px] sm:text-[17px] md:text-[18px] leading-relaxed">
          Stay informed on intellectual property laws, rules, and procedures. 
MENTORIP provides legal updates, explanations, and analysis of 
trademark, patent, and design legislation in Bangladesh and globally.
          </p>
        </div>
