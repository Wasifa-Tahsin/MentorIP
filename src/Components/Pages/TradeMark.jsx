...
import image2 from '../../assets/image/image box (1).png';
import image3 from '../../assets/image/image box (2).png';
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
        <div className="text-left max-w-2xl">
          ...
          <p className="text-[15px] sm:text-[17px] md:text-[18px] text-gray-700 leading-relaxed">
            ...
            We offer trademark search, filing, opposition, renewal, and enforcement 
